...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      ...
      <doc:description>If targetMarketCountryCode equals ('008' (Albania), '051' (Armenia), '031' (Azerbaijan), '040' (Austria), '112' (Belarus), '056' (Belgium), '070' (Bosnia-Herzegovina), '100' (Bulgaria), 
                                                          ...
                                                          and nutrientTypeCode is used, then nutrientTypeCode SHALL NOT be 'ENERA', 'NACL', 'SUGAR', 'CHO-' and 'FIB-'.
      </doc:description>    
      ...
      <doc:attribute2>nutrientTypeCode</doc:attribute2>       
   	  <rule context="nutrientDetail">
		    <assert test="if((ancestor::tradeItem/targetMarket/targetMarketCountryCode =  ('008' , '051' , '031' , '040', '112' , '056' , '070' , '100' , '191' , '196' , '203' , '233' , '246' , '250' , '268' , '300' , '348' ,
        					...
        					then (nutrientTypeCode != 'ENERA' and  nutrientTypeCode != 'NACL' and nutrientTypeCode != 'SUGAR' and  nutrientTypeCode != 'CHO-' and nutrientTypeCode != 'FIB-' )
        					          												
        							
				          				 else true()">	
				          				 
				          				 		 	<nutrientTypeCode><xsl:value-of select="nutrientTypeCode"/></nutrientTypeCode>				          		 
				          		 		
							      		 		<errorMessage>The nutrient type code used is not allowed in the target market.</errorMessage>
