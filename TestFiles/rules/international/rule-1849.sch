...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1849</title>      
      <doc:description>If targetMarketCountryCode equals '246' (Finland) and isTradeItemAConsumerUnit equals 'true' and  GDSNTradeItemClassification/gpcCategoryCode is in the GPC segment 50000000 and GPC family is not 50210000, then priceComparisonMeasurement SHALL be used.</doc:description>       
      ...
      <rule context="tradeItem">     
          <assert test="if ((targetMarket/targetMarketCountryCode =  '246') 	
     		            ...
     		            and (gdsnTradeItemClassification/gpcCategoryCode = ('10000002' , '10000003' , '10000005' , '10000006' , '10000007' , '10000008' , '10000016' , '10000017' , '10000018' , '10000019' ,  
	                                                                    ...
	                                                                    '10000115' , '10006311' , '10006312' , '10000118' , '10000119' , '10000210' , '10000313' )))  
        				then ((exists(tradeItemInformation/extension/*:salesInformationModule/salesInformation/priceComparisonMeasurement))
         				...
         				satisfies  ($node != '') ))                    
				          		 				...
				          		 				<priceComparisonMeasurement><xsl:value-of select="tradeItemInformation/extension/*:salesInformationModule/salesInformation/priceComparisonMeasurement"/></priceComparisonMeasurement>
							      		 		<errorMessage>For Country of Sale Code (#targetMarketCountryCode#), Price Comparison Quantity (#priceComparisonMeasurement#) is required for food product(s).</errorMessage>
