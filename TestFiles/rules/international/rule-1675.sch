...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1675</title>
      <doc:description>if componentIdentification/@identificationSchemeAgencyCode equals 'GTIN_8' 
                        then componentIdentification shall be exactly 8 digits long and have a valid check digit.
      </doc:description>
      ...
      <rule context="tradeItem">
		  <assert test="if (tradeItemInformation/tradeItemComponents/componentInformation/componentIdentification/@identificationSchemeAgencyCode = 'GTIN_8')
		                ...
		                return ($b - 48)) + number(substring($node, 8, 1))) mod 10 = 0 )) )         							
							      		 		...
							      		 		<errorMessage>componentIdentification shall be a valid GTIN_8 if the identificationSchemeAgencyCode equals 'GTIN_8' </errorMessage>
