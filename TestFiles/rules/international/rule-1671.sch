...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1671</title>
      <doc:description>if componentIdentification/@identificationSchemeAgencyCode equals 'GTIN_13' 
                        then componentIdentification shall be exactly 13 digits long and have a valid check digit.
      </doc:description>
      ...
      <rule context="tradeItem">
		  <assert test="if (tradeItemInformation/tradeItemComponents/componentInformation/componentIdentification/@identificationSchemeAgencyCode = 'GTIN_13')
