...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1160</title>
      <doc:description>If targetMarketCountryCode equals ('249' (France) or '250' (France)) and isTradeItemAConsumerUnit equals 'TRUE' then descriptionShort shall be used.</doc:description>
      ...
      <rule context="tradeItem">
          <assert test="if((targetMarket/targetMarketCountryCode =  ('249'(: France :) , '250'(: France :) )) 
        					...
        					satisfies ($node != '')))                  												
							      		 		...
							      		 		<errorMessage> If targetMarketCountryCode equals ('249' (France) or '250' (France)) and isTradeItemAConsumerUnit equals 'TRUE' then descriptionShort shall be used.
	                                            </errorMessage>
