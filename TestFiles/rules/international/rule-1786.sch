...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1786</title>      
      <doc:description>If NutrientDetail class is used, then all combinations of nutrientTypeCode and quantityContained/@measurementUnitCode values shall be unique within the same NutrientHeader class.</doc:description>    
      <doc:attribute1>gpcCategoryCode</doc:attribute1> 
      <doc:attribute2>nutrientTypeCode, quantityContained/@measurementUnitCode </doc:attribute2>       
   	  <rule context="nutrientHeader">
		    <assert test="if((not (ancestor::tradeItem/gdsnTradeItemClassification/gpcCategoryCode = $gpc/gpcDP007/gpcDP007Code))                                                                          									 					
            		        ...
            		        count(nutrientDetail/nutrientTypeCode[.!='ENER-'])))             												
				          				 		...
				          				 		<measurementUnitCode><xsl:value-of select="nutrientDetail/quantityContained/@measurementUnitCode"/></measurementUnitCode> 						          		 
				          		 		
							      		 		<errorMessage>For a Nutrient Header class, the Nutrient  and Unit of Measure must be unique.</errorMessage>
