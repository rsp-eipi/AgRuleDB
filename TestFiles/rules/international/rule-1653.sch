   ...
   <pattern>
      ...
      <rule context="tradeItem">
		  <assert test="if ((targetMarket/targetMarketCountryCode =  ('208', '826'))
		                ...
		                then exists(tradeItemInformation/extension/*:tradeItemTemperatureInformationModule/tradeItemTemperatureInformation/minimumTemperature)
         				and (every $node in (tradeItemInformation/extension/*:tradeItemTemperatureInformationModule/tradeItemTemperatureInformation/minimumTemperature)
         				  satisfies  $node!='')                   
           							        							
				          				 else true()">				          		 
				          		 		
							      		 		<errorMessage>If temperatureQualifierCode equals 'STORAGE_HANDLING',
							      		 		              then minimumTemperature SHALL be used  for any context other than 'DP007' or 'DP008'.
			      		 		                </errorMessage>
