...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1350</title>
	    <doc:description>If targetMarketCountryCode equals '840' (United States)
	                     and  creditableGrainGroupCode is used, 
	                     then doesTradeItemContainNoncreditableGrains, 
	                     and doesTradeItemMeetWholeGrainRichCriteria shall be used.
	    </doc:description>
        <doc:attribute1>targetMarketCountryCode,creditableGrainGroupCode</doc:attribute1>
        <doc:attribute2>doesTradeItemContainNoncreditableGrains,doesTradeItemMeetWholeGrainRichCriteria</doc:attribute2>
        <rule context="tradeItem">
            <assert test="if((targetMarket/targetMarketCountryCode =  ('840'(: United States :) ))
            			  ...
            			  satisfies ($node/doesTradeItemContainNoncreditableGrains != '' and $node/doesTradeItemMeetWholeGrainRichCriteria != '')))            			 
					            	   ...
					            	   <errorMessage>The attributes doesTradeItemContainNonCreditableGrains, 
					            	                 ...
					            	                 when the attribute creditableGrainGroupCode is used.
		        	                   </errorMessage>
