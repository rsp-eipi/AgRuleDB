...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1686</title>
      <doc:description>If targetMarketCountryCode equals ‘250’ (France) and gpcCategoryCode is in GPC Family ('67010000' (Clothing) or ‘63010000’ (Footwear)) and isTradeItemAConsumerUnit equals ‘true’ then additionalTradeItemDescription shall not be empty.</doc:description>
      ...
      <rule context="tradeItem">
          <assert test="if((targetMarket/targetMarketCountryCode =  ('250'(: France :) )) 
    					...
    					then (exists(additionalTradeItemIdentification) 
    					and (some $node in (additionalTradeItemIdentification)
    					satisfies ($node != '')))   
