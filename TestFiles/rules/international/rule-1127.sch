   ...
   <pattern>
      ...
      <rule context="tradeItem">
		  <assert test="if((targetMarket/targetMarketCountryCode =  ('249'(: France :) , '250'(: France :) )) 
    					...
    					and (tradeItemInformation/extension/*:packagingInformationModule/packaging/platformTypeCode = '43'))
    					...
    					then   ((number($node/depth) ge 1140) and (number($node/depth) le 2280)
            			and    (number($node/width) ge 1140) and (number($node/width) le 2280))                			
            			...
            			and    (number($node/width) ge 43.31) and (number($node/width) le 86.62))                   			 
							      		 		...
							      		 		<errorMessage>If targetMarketCountryCode equals ('249' (France) or '250' (France)) and  tradeItemUnitDescriptorCode equals 'PALLET' and platformTypeCode equals  '43', 
							      		 		              then TradeItemMeasurements/depth shall be between and including ('1140 MMT' or '43.31 IN') and  ('2280 MMT' or '86.62 IN') 
							      		 		              and TradeItemMeasurements/width shall be between and including ('1140 MMT' or '43.31 IN') and ('2280 MMT' or '86.62 IN').
	                                            </errorMessage>
