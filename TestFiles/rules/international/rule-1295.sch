...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1295</title>
      <doc:description>If gs1TradeItemIdentificationKeyCode  is equal to 'GTIN_8' 
                       then associated gs1TradeItemIdentificationKeyValue value must have 8 digits 
      ...
      <rule context="tradeItem">
		  <assert test="if (tradeItemInformation/extension/*:tradeItemDataCarrierAndIdentificationModule/gs1TradeItemIdentificationKey/gs1TradeItemIdentificationKeyCode = 'GTIN_8')
