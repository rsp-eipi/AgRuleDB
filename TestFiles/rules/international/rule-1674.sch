...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1674</title>
      <doc:description>if directPartMarkingIdentifier/@identificationSchemeAgencyCode equals 'GTIN_12' 
                        then  directPartMarkingIdentifier shall be exactly 12 digits long and have a valid check digit.
      </doc:description>
      ...
      <rule context="tradeItem">
		  <assert test="if (tradeItemInformation/extension/*:medicalDeviceTradeItemModule/medicalDeviceInformation/directPartMarkingIdentifier/@identificationSchemeAgencyCode = 'GTIN_12')
		                ...
		                return ($b - 48)) + number(substring($node, 12, 1))) mod 10 = 0 )) )         							
							      		 		...
							      		 		<errorMessage>directPartMarkingIdentifier shall be a valid GTIN_12 if the identificationSchemeAgencyCode equals 'GTIN_12' </errorMessage>
