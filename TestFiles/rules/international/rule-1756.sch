...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      ...
      <doc:description>If targetMarketCountryCode equals ('008' (Albania), '051' (Armenia), '031' (Azerbaijan), '040' (Austria), '112' (Belarus), '056' (Belgium), '070' (Bosnia-Herzegovina), '100' (Bulgaria), 
                                                          ...
                                                          and drainedWeight is used,
                                                          then the drainedWeight unit of measurement SHALL equal one of the following values: 'KGM' or 'GRM'.
      </doc:description>    
      ...
      <doc:attribute2>drainedWeight</doc:attribute2>       
   	  <rule context="tradeItem">
		    <assert test="if((targetMarket/targetMarketCountryCode =  ('008' , '051' , '031' , '040', '112' , '056' , '070' , '100' , '191' , '196' , '203' , '233' , '246' , '250' , '268' , '300' , '348' ,
        					...
        					satisfies ($node/drainedWeight/@measurementUnitCode = ('KGM' , 'GRM')))                    												
        							
				          				 else true()">					          		 
				          		 		
							      		 		<errorMessage>The drained weight unit of measure shall contain the value 'KGM' or 'GRM' for the target market.</errorMessage>
