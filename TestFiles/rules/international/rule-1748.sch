...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1748</title>      
      <doc:description>If gs1TradeItemIdentificationKeyCode is equal to 'ZERO_SUPPRESSED_GTIN', then the first digit of gs1TradeItemIdentificationKeyValue SHALL equal '0'.</doc:description>    
      ...
      <rule context="tradeItem">
     		   <assert test="if (tradeItemInformation/extension/*:tradeItemDataCarrierAndIdentificationModule/gs1TradeItemIdentificationKey/gs1TradeItemIdentificationKeyCode = 'ZERO_SUPPRESSED_GTIN')
		                ...
		                satisfies starts-with($node,'0')))
		                
		                	 else true()">		          		 
				          		 		
							      		 		<errorMessage>Zero Suppressed GTINs provided as a GS1 Trade Key shall begin with a "0".</errorMessage>
