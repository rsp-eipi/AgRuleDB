...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1297</title>
      <doc:description>If gs1TradeItemIdentificationKeyCode  is equal to 'GTIN_12' 
                       then associated gs1TradeItemIdentificationKeyValue value must have 12 digits 
      ...
      <rule context="tradeItem">
		  <assert test="if (tradeItemInformation/extension/*:tradeItemDataCarrierAndIdentificationModule/gs1TradeItemIdentificationKey/gs1TradeItemIdentificationKeyCode = 'GTIN_12')
