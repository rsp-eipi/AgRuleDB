...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      ...
      <doc:attribute2>additionalTradeItemIdentification/@additionalTradeItemIdentificationTypeCode</doc:attribute2>      
      <rule context="tradeItem">
          <assert test="if((targetMarket/targetMarketCountryCode =  ('250'(: France :) )) 
    					...
    					satisfies ($node = 'SUPPLIER_ASSIGNED')))   
    					
    						 else true()">			        		 
				          		 		
							      		 		<errorMessage>If the target market is France, and the product has a GPC brick code belonging to the family ('67010000' (clothing) or'63010000' (footwear)), and the hierarchy level is a base unit that is also a consumer unit then the supplier reference is mandatory.</errorMessage>
