...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1706</title>      
      <doc:description>If dietTypeCode equals ’VEGETARIAN’ and dietTypeSubcode is used and targetMarketCountryCode is not '840' (US), then dietTypeSubcode SHALL be a value in (‘OVO’, ‘LACTO ‘, ‘LACTO_OVO’).</doc:description>
     ...
     <rule context="tradeItem">
		  <assert test="if ((gdsnTradeItemClassification/gpcCategoryCode!='10005844') and (gdsnTradeItemClassification/gpcCategoryCode!='10005845') 
		                ...
		                then (every $node in (tradeItemInformation/extension/*:dietInformationModule/dietInformation/dietTypeInformation/dietTypeSubcode)
         				satisfies  ( $node = ('OVO' , 'LACTO', 'LACTO_OVO' ) ) ) 				 
				          				 	else true()">				          		 
				          		 		
							      		 		<errorMessage>The dietTypeSubcodeCode is not valid for a Vegetarian diet.</errorMessage>
