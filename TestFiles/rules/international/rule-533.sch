   ...
   <pattern>
      ...
      <rule context="tradeItem">
         <assert test="if ((targetMarket/targetMarketCountryCode = '528'(: Netherlands :) ) 
                       ...
                       then  exists(tradeItemInformation/extension/*:dutyFeeTaxInformationModule/dutyFeeTaxInformation/dutyFeeTax/dutyFeeTaxCategoryCode) 
                       and (every $node in (tradeItemInformation/extension/*:dutyFeeTaxInformationModule/dutyFeeTaxInformation/dutyFeeTax/dutyFeeTaxCategoryCode) 
                       satisfies not ( (empty($node)) ) )
         
         			   else true()">
         			   
         			   		
         			   		   <errorMessage>If targetMarket is equal to '528' (Netherlands) then dutyFeeTaxCategoryCode is required but was not provided.</errorMessage>
