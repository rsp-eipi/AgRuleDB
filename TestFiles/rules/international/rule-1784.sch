...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
   ...
   <pattern>
      <title>Rule 1784</title>      
      <doc:description>If batteryWeight is used then batteryWeight SHALL be greater than 0.</doc:description>    
      ...
      <doc:attribute2>batteryWeight</doc:attribute2>       
   	  <rule context="tradeItem">
		    <assert test="if((not (gdsnTradeItemClassification/gpcCategoryCode = $gpc/gpcDP007/gpcDP007Code))                                                                          									 					
        					...
        					satisfies ($node/batteryWeight  &gt; 0 ))                    												
        							
				          				 else true()">					          		 
				          		 		
							      		 		<errorMessage>For batteries the field Battery weight shall be greater than 0 (zero), if used.</errorMessage>
