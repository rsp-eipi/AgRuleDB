...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <pattern>
      <title>Rule FR_003</title>
      <doc:description>If platformTypeCode is populated then quantityOfCompleteLayersContainedInATradeItem must be populated</doc:description>
      <doc:attribute1>quantityOfCompleteLayersContainedInATradeItem, platformTypeCode</doc:attribute1>
      <rule context="tradeItem">
          <assert test="if ((targetMarket/targetMarketCountryCode =  ('249'(: France :) , '250'(: France :) ))
          	   ...
          	   <errorMessage>Il est obligatoire d'indiquer le nombre de couche pour une palette (quantityOfCompleteLayersContainedInATradeItem) si le type de support palette (platformTypeCode) est renseigné.</errorMessage>
