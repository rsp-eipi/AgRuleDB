...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
   ...
   <pattern>
      <title>Rule FR_205</title>
       <doc:description>If one iteration of targetMarketCountryCode equals '250' (France) and if priceComparisonContentTypeCode is used then priceComparisonMeasurement shall be used.</doc:description>
       <doc:attribute1>targetMarketCountryCode,priceComparisonContentTypeCode</doc:attribute1>
       ...
       <rule context="tradeItem">
          <assert test="if((targetMarket/targetMarketCountryCode = '250')
            			    ...
            			    satisfies ($node != '')))           				    					 
		          	 	       ...
		          	 	       <errorMessage>Pour le marché cible France, si le code du type de contenu de comparaison des prix est renseigné, alors la mesure de comparaison des prix doit être renseignée.</errorMessage>
