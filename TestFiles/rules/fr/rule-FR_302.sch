...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
   ...
   <pattern>
      <title>Rule FR_302</title>
       <doc:description>If targetMarketcountrycode equals '250' (France) and If PlaceOfItemActivityModule/../productActivityTypeCode equals 'CATCH_ZONE', then catchAreaCode SHALL be used.</doc:description>
       ...
       <rule context="tradeItem">
          <assert test="if((targetMarket/targetMarketCountryCode = '250')
        					...
        					satisfies ($node != '')))          				    					 
		          	 	       ...
		          	 	       <errorMessage>Pour le marché cible France, si le code de type d'activité est égal à 'CATCH_ZONE' alors la zone de pêche/capture doit être renseigné.</errorMessage>
